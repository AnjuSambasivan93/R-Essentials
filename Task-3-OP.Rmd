...
-   This approach **zooms in** on the y-axis between 0 and 50 without removing any data points outside this range.
    ...
    "Without removing any data points outside this range": it still exists in the plot's structure, but you won’t see it if you zoom in to only show the 0-50 range.
...
-   How It Works:
    ...
    If you add a variable that doesn’t help improve the model, Adjusted R-squared will decrease.
